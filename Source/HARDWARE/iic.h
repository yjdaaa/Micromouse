...
#define SDA_IN()  {GPIOC->CRL&=0XFFFFFFF0;GPIOC->CRL|=0x00000008;}
#define SDA_OUT() {GPIOC->CRL&=0XFFFFFFF0;GPIOC->CRL|=0x00000007;}

 
#define IIC_SCL    PCout(1) 
#define IIC_SDA    PCout(0)  
#define READ_SDA   PCin(0)  
